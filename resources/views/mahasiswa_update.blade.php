                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            @endif
                            <div class="card-body">
                                <form method="post" action="{{ url('/mahasiswa_update/' . $mahasiswa->mahasiswa_id) }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="mahasiswa_kelas"
                                            value="{{ old('mahasiswa_kelas', $mahasiswa->mahasiswa_kelas) }}">
                                    </div>
                                    <div class="form-group">
                                        <label>NRP</label>
                                        <input type="text" class="form-control" name="mahasiswa_nrp"
                                            value="{{ old('mahasiswa_nrp', $mahasiswa->mahasiswa_nrp) }}">
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
